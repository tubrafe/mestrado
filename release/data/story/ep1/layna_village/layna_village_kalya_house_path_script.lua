...
function _ReloadGrandmaDialogue()
    ...
    -- Preserve quest progress when chickens were found before talking to Grandma.
    if (chicken_left < 3 and GlobalManager:GetGameEvents():GetEventValue("game", "layna_village_chicken_reward_given") == 0) then
...
function _CreateEvents()
    -- Triggered Events
    vt_map.MapTransitionEvent.Create("to Village center", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_script.lua", "from_kalya_house_path");

    vt_map.MapTransitionEvent.Create("to Kalya house exterior", "data/story/ep1/layna_village/layna_village_kalya_house_exterior_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_exterior_script.lua", "from_kalya_house_path");

    vt_map.MapTransitionEvent.Create("to grandma house", "data/story/ep1/layna_village/layna_village_kalya_house_path_small_house_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_path_small_house_script.lua", "from_kalya_house_path");

    vt_map.MapTransitionEvent.Create("to Kalya house small passage", "data/story/ep1/layna_village/layna_village_kalya_house_exterior_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_exterior_script.lua", "from_kalya_house_path_small_passage");
end
