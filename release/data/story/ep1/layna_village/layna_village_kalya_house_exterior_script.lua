...
function _CreateCharacters()
    ...
    if (GlobalManager:GetMapData():GetPreviousLocation() == "from_kalya_house_interior") then
        bronann:SetPosition(44, 18);
        bronann:SetDirection(vt_map.MapMode.SOUTH);
    end

    if (GlobalManager:GetMapData():GetPreviousLocation() == "from_kalya_house_path_small_passage") then
...
function _CreateObjects()
    ...
    vt_map.SoundObject.Create("data/sounds/gentle_stream.ogg", 10.0, 46.0, 20.0);
end
...
function _CreateEvents()
    ...
    -- Triggered Events
    vt_map.MapTransitionEvent.Create("to Kalya house path", "data/story/ep1/layna_village/layna_village_kalya_house_path_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_path_script.lua", "from_kalya_house_exterior");

    vt_map.MapTransitionEvent.Create("to kalya house path small passage", "data/story/ep1/layna_village/layna_village_kalya_house_path_map.lua",
                                     "data/story/ep1/layna_village/layna_village_kalya_house_path_script.lua", "from_kalya_house_small_passage");
