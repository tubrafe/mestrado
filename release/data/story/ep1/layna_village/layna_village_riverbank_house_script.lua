...
function _CreateEvents()
    -- Triggered events
    vt_map.MapTransitionEvent.Create("exit floor", "data/story/ep1/layna_village/layna_village_riverbank_map.lua",
                                     "data/story/ep1/layna_village/layna_village_riverbank_script.lua", "from_riverbank_house");
end
