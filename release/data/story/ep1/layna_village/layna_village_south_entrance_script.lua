...
function _CreateCharacters()
    ...
    elseif (GlobalManager:GetMapData():GetPreviousLocation() == "from right house") then
        bronann:SetPosition(48, 34);
        bronann:SetDirection(vt_map.MapMode.SOUTH);
        AudioManager:PlaySound("data/sounds/door_close.wav");
    elseif (GlobalManager:GetMapData():GetPreviousLocation() == "from left house") then
...
function _CreateEvents()
    ...
    vt_map.MapTransitionEvent.Create("to Village center", "data/story/ep1/layna_village/layna_village_center_map.lua",
                                     "data/story/ep1/layna_village/layna_village_center_script.lua", "from_village_south");

    vt_map.MapTransitionEvent.Create("to Village riverbank", "data/story/ep1/layna_village/layna_village_riverbank_map.lua",
                                     "data/story/ep1/layna_village/layna_village_riverbank_script.lua", "from_village_south");

    vt_map.MapTransitionEvent.Create("to left house", "data/story/ep1/layna_village/layna_village_south_entrance_left_house_map.lua",
                                     "data/story/ep1/layna_village/layna_village_south_entrance_left_house_script.lua", "from_village_south");

    vt_map.MapTransitionEvent.Create("to right house", "data/story/ep1/layna_village/layna_village_south_entrance_right_house_map.lua",
                                     "data/story/ep1/layna_village/layna_village_south_entrance_right_house_script.lua", "from_village_south");
