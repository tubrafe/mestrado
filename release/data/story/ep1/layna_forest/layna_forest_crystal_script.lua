...
function _HandleTwilight()
    ...
    Map:GetScriptSupervisor():AddScript("data/story/ep1/layna_forest/after_crystal_twilight.lua");
end
...
function _CreateEvents()
    ...
    -- Triggered events
    vt_map.MapTransitionEvent.Create("to forest cave 2", "data/story/ep1/layna_forest/layna_forest_cave2_map.lua",
                                     "data/story/ep1/layna_forest/layna_forest_cave2_script.lua", "from layna forest crystal");
    ...
    event:AddEventLinkAtEnd("study end dialogue");

    dialogue = vt_map.SpriteDialogue.Create();
    text = vt_system.Translate("Fim da bateria de testes. Obrigado por jogar.");
    dialogue:AddLine(text, nil);
    text = vt_system.Translate("Sua sessao de teste foi concluida.");
    dialogue:AddLine(text, nil);
    event = vt_map.DialogueEvent.Create("study end dialogue", dialogue);
    event:AddEventLinkAtEnd("study return to menu");

    vt_map.ScriptedEvent.Create("study return to menu", "study_return_to_menu", "");
    ...
    vt_map.SoundEvent.Create("crystal voice sound 1", "data/story/ep1/layna_forest/crystal_appearance/crystal-sentence1.ogg")
    vt_map.SoundEvent.Create("crystal voice sound 2", "data/story/ep1/layna_forest/crystal_appearance/crystal-sentence2.ogg")
    vt_map.SoundEvent.Create("crystal voice sound 3", "data/story/ep1/layna_forest/crystal_appearance/crystal-sentence3.ogg")
    vt_map.SoundEvent.Create("crystal voice sound 4", "data/story/ep1/layna_forest/crystal_appearance/crystal-sentence4.ogg")
    vt_map.SoundEvent.Create("crystal voice sound 5", "data/story/ep1/layna_forest/crystal_appearance/crystal-sentence5.ogg")
    vt_map.SoundEvent.Create("crystal voice sound 6", "data/story/ep1/layna_forest/crystal_appearance/crystal-sentence6.ogg")
